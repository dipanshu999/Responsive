...
<div className='box-container flex flex-wrap items-center justify-center p-4 gap-4 mob:p-12 mob:gap-12 bg-yellow-50'>
        {Array.from({ length: 8 }, (_, i) => (
          <div key={i} ref={addToRefs} className="box border-2 overflow-hidden bg-white border-red-400 rounded-xl w-[140px] h-[200px] xsm:w-[180px] xsm:h-[240px]">
    ...
    <div ref={textRef} data-scroll data-scroll-speed="-2" className="  blob w-[100vw] h-[20em] bg-[url('/blob.svg')] bg-no-repeat opacity-85  flex items-center justify-center  mob:h-[32em] tab:h-[42em] ">
